...
typedef MatrixGestureDetectorCallback = void Function(Matrix4 matrix, Matrix4 translationDeltaMatrix, Matrix4 scaleDeltaMatrix, Matrix4 rotationDeltaMatrix);
...
class _MatrixGestureDetectorState extends State<MatrixGestureDetector> {
  ...
  // Matrix4 matrix = widget.inputMatrix != null ? widget.inputMatrix! : Matrix4.identity();
...
//       onPanEnd: widget.onPanEnd,
  ...
  Offset testOffset = Offset(0.0, 0.0);
  ...
  // void onUndo(ScaleUpdateDetails details) {
  //   translationDeltaMatrix = Matrix4.identity();
  //   scaleDeltaMatrix = Matrix4.identity();
  //   rotationDeltaMatrix = Matrix4.identity();
  ...
  //   widget.onMatrixUpdate(widget.inputMatrix, translationDeltaMatrix, scaleDeltaMatrix, rotationDeltaMatrix);
  // }
